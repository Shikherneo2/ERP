...
<div class="container">
  ...
  <form method="post" action="purchase_php.php">
    <table cellpadding="2" cellspacing="0" class="top_table">
      <tr>
        <th>Supplier Name : </th>
        <td><select name="supp_name">
        <?php
            ...
            $result = $db->query($qry);
             ...
             while($row=$result->fetch(SQLITE3_ASSOC)){
                   echo "<option>".$row['supp_name']."</option>";     
             }
        ?></select></td>
      </tr>
      <tr>
        <th>Additional Details : </th>
        <td><textarea name="details" name =details id="details" cols="45" rows="5"></textarea></td>
      </tr>
    </table>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    ...
    <table cellpadding="2" cellspacing="0" id="add_line" style="margin-top:15px;">
      ...
      <tr>
        ...
        <td>
          <input type="text" name="a1_2" id="a1_2" onKeyPress="now2(event, this,2)" onBlur="hide2()" autocomplete="off"><br>
          <table class="suggest" id="wow"></table>
        </td>
        <td>
          <input type="text" class="sml_txt" name="a1_3" id="a1_3" onBlur="calc()">
        </td>
        <td>
        ...
        <td>
          <input type="text" class="sml_txt" name="a1_5" id="a1_5" >
        </td>
      </tr>
   ...
   <br>
     ...
     <br>
      Total Amount : <input type=text id="total"><br><br>
    </center>
  <!-- end .content --></div>
  <!-- end .container --></div>
</body>

...
<title>Show Products By Category</title>
<!-- TemplateEndEditable -->
...
function do3(type){
  if(document.getElementById('category').value=='')
    ...
    if(type==2){
      document.getElementById('form6').action = "show_by_category.php"; 
    }
    document.getElementById('form6').submit();   
  }
}
...
<div class="container">
  <div class="sidebar1">
    <ul class="nav">
      ...
      <li><a href="add_category.php" class="current">Add Category</a></li>
  ...
  <form method="post" action="category_php.php" id="form6">
    Enter Category  :
    <input type=text name="category" id="category" style="height:24px;">
    
    <input type=button value="Add Category" style="width:150px; height:30px" onClick="do3(1)">
    <input type=button value="Find products by Category" style="padding-left:10px; padding-right:10px; height:30px" onClick="do3(2)">
  </form><br><br>
  ...
  <table cellpadding="6" cellspacing="0">
    ...
    <?php
      ...
      $qry = "SELECT name, code, category, init_qty,location FROM products where category like '%".$loc."%' collate nocase order by name desc";
      ...
      if($count==0)
          echo "<tr><td> No Items in this Category</td></tr>";

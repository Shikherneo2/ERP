...
<div class="container">
  <div class="sidebar1">
    <ul class="nav">
      ...
      <li><a href="sales_order.php" class="current">Sales Order</a></li>
  ...
  <br>
  <form method="post" action="sales_order_php.php">
    ...
    <table align="center" border="1" cellpadding="5" cellspacing="0" id="add_line" style="margin-top:15px;">

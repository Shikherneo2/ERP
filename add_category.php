...
<div class="container">
  <div class="sidebar1">
   ...
   <br>
  <div class="content" style="padding-left:80px;"><br>
  <?php 
  ...
  <form method="post" action="category_php.php" id="form6">
	  ...
	  <input type=button value="Add Category" style="width:150px; height:30px" onClick="do2(1)">
	  <input type=button value="Find products by Category" style="padding-left:10px; padding-right:10px; height:30px" onClick="do2(2)">
  </form><br><br>

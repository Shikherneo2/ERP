...
<div class="container">
  <div class="sidebar1">
    <ul class="nav">
      ...
      <li><a href="inventory.php" class="current">Current Inventory</a></li>
  ...
  <table cellpadding="2" cellspacing="0">
    ...
    $result2=$db->query("SELECT name, code, category, init_qty, location FROM products order by name asc");

...
<div class="container">
  <div class="sidebar1">
    <ul class="nav">
      ...
      <li><a href="show_prods.php" class="current">View Products</a></li>
      <li><a href="logout.php">Logout</a></li>
    </ul>
   Use These menu options to go to the desired page on the right</div>
   <br>
  <div class="content" style="padding-left:80px; padding-bottom:70px;"><br />
  <table border=1 cellpadding="2" cellspacing="0">
    ...
    $result2=$db->query("SELECT name, code, category, desc, remarks, price FROM products");

    while($row=$result2->fetch(SQLITE3_ASSOC)){
          
          echo '<tr><td>'.$row['name'].'</td><td>'.$row['code'].'</td><td>'.$row['category'].'</td><td>'.$row['desc'].'</td><td>'.$row['remarks'].'</td><td>'.$row['price'].'</td></tr>';
    }
